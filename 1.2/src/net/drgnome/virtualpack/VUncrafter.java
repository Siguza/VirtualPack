...
public class VUncrafter extends ContainerChest
{
    ...
    public VUncrafter(EntityPlayer player)
    {
        ...
        this.player = player;
        d = new ArrayList(); // Derpnote
        e = new ArrayList(); // Derpnote
        for(int i = 0; i < 2; i++)
        {
            for(int j = 0; j < 9; j++)
            {
    ...
    public ItemStack clickItem(int i, int j, boolean flag, EntityHuman entityhuman)
    {
        ...
        if((j == 0) || (j == 1))
        {
            ...
            {
                ItemStack itemstack1 = a(i); // Derpnote
                if(itemstack1 != null)
                {
                    int k = itemstack1.id;
                    itemstack = copy(itemstack1);
                    Slot slot = (Slot)this.e.get(i); // Derpnote
            ...
            else
            {
                ...
                Slot slot1 = (Slot)this.e.get(i); // Derpnote
                if(slot1 != null)
                {
                    slot1.d(); // Derpnote
                    ...
                    else if(itemstack3 == null)
                    {
                        ...
                        slot1.c(playerinventory.getCarried()); // Derpnote
                    }
